...
.click(function() {
	...
	$.download('http://localhost:9527/api/car/export/shortcut',params, 'post');
});
...
function doSearch() {
    ...
    $.ajax({
            url: "http://localhost:9527/api/car/search",
            type: "POST",
            dataType: "json",
...
function loadMailList() {
    $.ajax({
        url: "http://localhost:9527/api/car/config/maillist",
        type: "GET",
        dataType: "json",
        data: "",
        success: function(data) {
...
function initQueryPage() {
    $.ajax({
        url: "http://localhost:9527/api/car/query/brandlist",
        type: "GET",
        dataType: "json",
        data: "",
        success: function(data) {
    ...
    $.ajax({
        url: "http://localhost:9527/api/car/query/ztlist",
        type: "GET",
        dataType: "json",
        data: "",
        success: function(data) {
    ...
    $.ajax({
        url: "http://localhost:9527/api/car/query/pagetypelist",
        type: "GET",
        dataType: "json",
        data: "",
        success: function(data) {
    ...
    $.ajax({
        url: "http://localhost:9527/api/car/query/appskulist",
        type: "GET",
        dataType: "json",
        data: "",
        success: function(data) {
    ...
    $.ajax({
        url: "http://localhost:9527/api/car/query/channellist",
        type: "GET",
        dataType: "json",
        data: "",
        success: function(data) {
